...
Ce jeu de données est particulièrement adapté aux problématiques de :

- prévision du trafic réseau ;
- détection d'anomalies ;
- prévision de congestion des antennes cellulaires ;
- analyse des comportements urbains ;
- détection d'événements ;
- modélisation spatio-temporelle ;
- optimisation des réseaux 4G et 5G.

Dans le cadre de ce projet, il sera utilisé pour la **détection d'anomalies dans le trafic des réseaux cellulaires**, en exploitant :

- la dimension temporelle (mesures toutes les 10 minutes) ;
- la dimension spatiale (différentes zones de Milan) ;
- les différents types de trafic (SMS, appels et Internet).